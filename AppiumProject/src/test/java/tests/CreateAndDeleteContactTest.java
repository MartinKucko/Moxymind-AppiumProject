...
public class CreateAndDeleteContactTest extends AndroidBaseTest {
    ...
    public void CreateAndDeleteContact(HashMap<String, String> input) {
        ...
        listContactsPage.deleteAllContacts();
        listContactsPage.noContactsMessage();
    }

    @DataProvider
    public Object[][] getData() throws IOException {
        List<HashMap<String, String>> data = getJsonData(System.getProperty("user.dir") + "//src//test//java//testData//contactsList2.json");
